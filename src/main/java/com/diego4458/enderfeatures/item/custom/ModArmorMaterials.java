...
{
    ENDERIUM("enderium", 30, new int[]{4, 7, 9, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.5f, 0.1f, () -> Ingredient.ofItems(ModItems.ENDERIUM_INGOT)),
    ENDERIUM_NETHERITE("enderium_netherite", 30, new int[]{5, 8, 10, 5}, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4f, 0.1f, () -> Ingredient.ofItems(ModItems.ENDERIUM_INGOT));
