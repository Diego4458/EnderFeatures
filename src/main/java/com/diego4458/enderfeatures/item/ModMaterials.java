...
public enum ModMaterials implements ToolMaterial {
    ENDERIUM(MiningLevels.NETHERITE, 3031, 11.0f, 5.0f, 15, () -> Ingredient.ofItems(ModItems.ENDERIUM_INGOT)),
    ENDERIUM_NETHERITE(MiningLevels.NETHERITE, 4031, 13.0f, 6.0f, 15, () -> Ingredient.ofItems(ModItems.ENDERIUM_INGOT));
